                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          final base64StringPhoto = base64Decode(state.majors[index].photo ?? '');
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(image: MemoryImage(base64StringPhoto)),
                                  ),
                                ),
                              ),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        MouseRegion(
                                          onEnter: (_) =>
                                              _manageMajorsCubit.updateHovering(deleteKey, true),
                                          onExit: (_) =>
                                              _manageMajorsCubit.updateHovering(deleteKey, false),
                                          child: InkWell(
                                            onTap: () => {},
                                            child: Container(
                                        ...
                                        MouseRegion(
                                          onEnter: (_) =>
                                              _manageMajorsCubit.updateHovering(updateKey, true),
                                          onExit: (_) =>
                                              _manageMajorsCubit.updateHovering(updateKey, false),
                                          child: InkWell(
                                            onTap: () => context.router.push(UpdateMajorsRoute()),
                                            onHover: (hovering) {},
                                            child: Container(
                                              padding: const EdgeInsets.all(6),
                                              child: Text(
