...
class UserArticlesPage
    extends BasePage<UserArticlesCubit, UserArticlesBuildable, UserArticlesListenable> {
  UserArticlesPage({super.key});
  ...
  @override
  Widget builder(BuildContext context, UserArticlesBuildable state) {
    return Scaffold(
